...
name: Shyam S
located_in: India
education: "B.Tech Computer Science @ SRM IST KTR"
current_focus: "AI / Machine Learning, Full-Stack Development"
currently_learning: "DSA in Java, REST APIs, Docker"
collaborating_on: "AI-Powered Chatbot & automation frameworks"
ask_me_about: "Python, Java, Flask, chatbots, web apps"
fun_fact: "I talk to chatbots more than humans 🤖"
```
...
|---------|-------------|------|
| 🤖 [AI-Powered Chatbot](https://github.com/shyam-528/AI-Powered-Chatbot) | End-to-end AI chatbot with session memory, responsive chat UI, REST API & Docker deployment | `Python` `Flask` `Gemini API` `Docker` |
| 📚 [learnings](https://github.com/shyam-528/learnings) | 45 Java programs across `basic` / `intermediate` / `advanced` branches — my college coding journey | `Java` `DSA` `OOP` |
| ✅ [to-do-list-app](https://github.com/shyam-528/to-do-list-app) | Responsive task manager: filters, priorities, due dates, dark mode, drag-and-drop, localStorage | `HTML` `CSS` `JavaScript` |
| 🌦️ [weather-dashboard](https://github.com/shyam-528/weather-dashboard-) | Live weather data & multi-day forecasts with search, geolocation & dynamic icons | `TypeScript` `REST API` |
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/shyam-528/shyam-528/output/github-contribution-grid-snake-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/shyam-528/shyam-528/output/github-contribution-grid-snake.svg">
    <img height="100%" width="100%" alt="Contribution Snake Animation" src="https://raw.githubusercontent.com/shyam-528/shyam-528/output/github-contribution-grid-snake.svg">
  </picture>
</div>
